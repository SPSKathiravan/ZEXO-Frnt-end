      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative">
            <div className="aspect-square rounded-2xl bg-linear-to-br from-teal-500 to-cyan-400 opacity-20"></div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8">
              <div className="w-16 h-16 bg-linear-to-br from-teal-500 to-cyan-400 rounded-xl flex items-center justify-center mx-auto mb-6">
        ...
        {/* Team Section */}
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white text-center mb-12">Our Team</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-32 h-32 bg-linear-to-br from-teal-500 to-cyan-400 rounded-full mx-auto mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Alex Johnson</h3>
              <p className="text-teal-500 mb-2">Creative Director</p>
              <p className="text-gray-600 dark:text-slate-400">Leading design innovation with a passion for user-centered experiences.</p>
            </div>
            <div className="text-center">
              <div className="w-32 h-32 bg-linear-to-br from-teal-500 to-cyan-400 rounded-full mx-auto mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Sarah Chen</h3>
              <p className="text-teal-500 mb-2">Lead Developer</p>
              <p className="text-gray-600 dark:text-slate-400">Full-stack developer specializing in modern web technologies and scalable solutions.</p>
            </div>
            <div className="text-center">
              <div className="w-32 h-32 bg-linear-to-br from-teal-500 to-cyan-400 rounded-full mx-auto mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Mike Rodriguez</h3>
              <p className="text-teal-500 mb-2">Project Manager</p>
              <p className="text-gray-600 dark:text-slate-400">Ensuring seamless project execution and client satisfaction from start to finish.</p>
            </div>
          </div>
        </div>
